    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col-sm-12">
                            ...
                            <tbody>
                                ...
                                while ($row = $result_data->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="CrEdit.php?eCr_id=<?php echo $row['Course_id']; ?>"><button type="button" class="btn-success">Edit</button></a>
                                            <a href="delete.php?Cr_id=<?php echo $row['Course_id']; ?>"><button type="button" name="delete" class="btn-danger">Delete</button></a>
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
                ...
                <a href="CrDynamic.php" class="btn btn-primary">Add</a>
