    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col-sm-12">
                <div class="table-responsive">
                    ...
                    if ($result_data->num_rows > 0) {
                        ...
                        <table class="table table-bordered table-striped table-hover ">
                            <caption class="h1"> Student Information</caption>
                            <thead>
                                <tr>
                                    <th>Serial No.</th>
                                    <th>student's Id</th>
                            ...
                            <tbody>
                                ...
                                while ($row = $result_data->fetch_assoc()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="StiEdit.php?esti_id=<?php echo $row['Student_id']; ?>"><button type="button" class="btn-success">Edit</button></a>
                                            <a href="delete.php?Sti_id=<?php echo $row['Student_id']; ?>"><button type="button" name="delete" class="btn-danger">Delete</button></a>
                                        </td>
                                    </tr>
                                    <?php
                                    $i++;
                ...
                <a href="StiDynamic.php" class="btn btn-primary">Add</a>
